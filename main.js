...
async function _quickTest() {
  ...
  if (s.ffmpeg && !s.ffmpegWebp) conn.logger.warn('Stiker tidak dapat dianimasikan tanpa libwebp di ffmpeg  (--enable-ibwebp while compiling ffmpeg)')
...
_quickTest()
  .then(() => conn.logger.info('Tes selesai'))
  .catch(console.error)